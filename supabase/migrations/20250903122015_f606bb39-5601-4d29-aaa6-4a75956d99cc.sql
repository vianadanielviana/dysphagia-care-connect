...
-- Drop ALL existing policies on cadastro table
...
DROP POLICY IF EXISTS "Users can view their own cadastro records" ON public.cadastro;
DROP POLICY IF EXISTS "Users can create their own cadastro records" ON public.cadastro;
DROP POLICY IF EXISTS "Users can update their own cadastro records" ON public.cadastro;
DROP POLICY IF EXISTS "Users can delete their own cadastro records" ON public.cadastro;
...
DROP TRIGGER IF EXISTS set_cadastro_user_id_trigger ON public.cadastro;
